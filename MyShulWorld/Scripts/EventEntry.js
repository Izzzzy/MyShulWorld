...
$(function () {
    ...
    $('#recurring').hide();
    // don't know what this is: $('#select-list').hide();
    $('#from-to').hide();
    ...
    for (var k = 0; k < $('#restrictions-list').val() - 1; k++) {
        addRestriction();
        addExclusion();
    }
    ...
    function addRestriction() {
        $('#more-restrictions').append('<h4>Only when it falls out on:</h4>' +
           ...
           '<select name="restriction' + restrictionCount + '[]" multiple id="restriction' + restrictionCount + '">' +
                ...
                '<option value="Sunday" @Model.CheckIfSelected("Sunday", ' + restrictionCount + ')>Sunday</option>' +
                '<option value="Monday" @Model.CheckIfSelected("Monday", ' + restrictionCount + ')>Monday</option>' +
                '<option value="Tuesday" @Model.CheckIfSelected("Tuesday", ' + restrictionCount + ')>Tuesday</option>' +
                '<option value="Wednesday" @Model.CheckIfSelected("Wednesday", ' + restrictionCount + ')>Wednesday</option>' +
                '<option value="Thursday" @Model.CheckIfSelected("Thursday", ' + restrictionCount + ')>Thursday</option>' +
                '<option value="Friday" @Model.CheckIfSelected("Friday", ' + restrictionCount + ')>Friday</option>' +
           '</select>' +
           '</div>');
    ...
    function addExclusion() {
        $('#more-exclusions').append('<h4 style="margin-top: 20px">and only if also falls out on:</h4>' +
           ...
           '<option value="Shabbos"@Model.CheckIfSelected("Shabbos", ' + exclusionCount + ')>Shabbos</option>' +
                ...
                '<option value="Sunday" @Model.CheckIfSelected("Sunday", ' + exclusionCount + ')>Sunday</option>' +
                '<option value="Monday" @Model.CheckIfSelected("Monday", ' + exclusionCount + ')>Monday</option>' +
                '<option value="Tuesday" @Model.CheckIfSelected("Tuesday", ' + exclusionCount + ')>Tuesday</option>' +
                '<option value="Wednesday" @Model.CheckIfSelected("Wednesday", ' + exclusionCount + ')>Wednesday</option>' +
                '<option value="Thursday" @Model.CheckIfSelected("Thursday", ' + exclusionCount + ')>Thursday</option>' +
                '<option value="Friday" @Model.CheckIfSelected("Friday", ' + exclusionCount + ')>Friday</option>' +
